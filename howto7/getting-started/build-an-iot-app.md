...
For enterprises with Logistical operations, goods in transit are often exposed to changes in environmental conditions, such as  temperature, light, humidity and movement. Extreme irregularities lead to irrecoverable damage and substantial financial losses, increased insurance premiums, cancelled deliveries and unhappy customers.

In this tutorial, you are going to modify an IoT sample app to a set of custom requirements.
