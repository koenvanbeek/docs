...
In this tutorial we are gradually introducing you to the different aspects of Mendix App development. In seven steps you will learn:
- to start a new App and instantly run it.
- to apply some basic changes to the User Interface (UI).
